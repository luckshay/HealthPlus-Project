    ...
    <>
      ...
      <div className="container">
        ...
        <form className="login-form" onSubmit={handle}>
          ...
          <input type="text" id="name" name="name" value={formdata.name} onChange={handleonChange} placeholder='Enter Username'required></input>
          ...
          <input type="password" id="passsword" name="password" value={formdata.password} onChange={handleonChange} placeholder='Enter Password' required></input>
          <label htmlFor="confirm password">Confirm Password</label>
          <input type="password" id="confirmpassword" name="confirmPassword" value={formdata.confirmPassword} onChange={handleonChange} placeholder='Enter Password Again' required></input>
